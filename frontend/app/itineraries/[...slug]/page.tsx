...
const page = () => {
  ...
  return (
    <div
      className="mt-4 p-6 rounded-xl  border border-white/20"
    >      <DottedGlowBackground
      ...
      <h2 className="text-2xl font-bold mb-4 dark:text-white">for {itinerary ? itinerary.duration : "Loading..."} days</h2>
